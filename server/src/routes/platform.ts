...
关注我，获取更多干货分享 👇`,
      tips: PLATFORM_RULES.wechat.tips
    },
    zhihu: {
...
你有什么好的经验？欢迎评论分享。`,
      tips: PLATFORM_RULES.zhihu.tips
    },
    xiaohongshu: {
...
#干货分享 #实用技巧 #效率提升`,
      tips: PLATFORM_RULES.xiaohongshu.tips
    },
    toutiao: {
...
据了解，目前已有大量用户开始实践这些方法，并取得了良好效果。`,
      tips: PLATFORM_RULES.toutiao.tips
    },
    weibo: {
      title: `#${title}# 实用方法分享`,
      content: `#${title}# #实用技巧#
...
觉得有用的转发+关注 👍`,
      tips: PLATFORM_RULES.weibo.tips
    }
  }
